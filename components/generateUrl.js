export default function generateUrl (currentTime, sunsetTime, weatherStatus) {
    ...
    let dayTime = parseInt(currentTime) < sunsetTimeCorrect ? 'sun' : 'moon';
    ...
    if (dayTime === 'sun') {
        switch(parseInt(weatherStatus)) {
            ...
            case 1135: return require('../assets/img/3dweathericons/sun/Overcast.png');
            case 1147: return require('../assets/img/3dweathericons/sun/FreezeSnow.png');
        ...
        switch(parseInt(weatherStatus)) {
            ...
            case 1147: return require('../assets/img/3dweathericons/moon/FreezeSnow.png');
